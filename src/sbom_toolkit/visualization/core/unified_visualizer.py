...
class UnifiedVisualizer:
    """Main orchestrator for SBOM visualizations with multiple layout support."""
    ...
    def __init__(self):
        ...
        self.available_layouts = list(self.engines.keys())
    ...
    def create_visualization(
        ...
        Args:
            ...
            layout_types: List of layout types to include (default: all)
        ...
        if layout_types is None:
            layout_types = self.available_layouts

        # Validate layout types
        invalid_layouts = [lt for lt in layout_types if lt not in self.available_layouts]
        if invalid_layouts:
            raise ValueError(
                f"Invalid layout types: {invalid_layouts}. Available: {self.available_layouts}"
            )
