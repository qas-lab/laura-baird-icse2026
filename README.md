...
The SBOM Toolkit applies graph neural networks to software supply chain security. The core contribution is a dual-model approach for vulnerability analysis:
...
The training data and model checkpoints are hosted on Harvard Dataverse:

**DOI**: [10.7910/DVN/A6CZRB](https://doi.org/10.7910/DVN/A6CZRB)
...
```bash
# Full pipeline: generate SBOM, scan, build knowledge graph (KG built automatically)
